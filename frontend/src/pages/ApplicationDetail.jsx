  ...
  return (
    <div>
      ...
      <div className="detail-grid">
        ...
        <Field label={t("apps_submitted_at")} value={formatDate(application.submitted_at)} />
      </div>

      <RoleGate roles={["super_admin", "admin"]}>
        <div className="panel">
          <h2 className="panel-title">{t("detail_change_status")}</h2>
      ...
      <div className="panel">
        <h2 className="panel-title">{t("detail_history")}</h2>
